...
def perfect_model_test(var, number, resample_interval, trunc):
    ...
    plt.savefig('/nesi/project/niwa00015/queenle/plots/fire/perfect_model/'+var+'/6month_fire_season/smaller/'+resample_interval+'/' + 'PM_ens_' + number + '.png')
    plt.close(fig)
...
def get_mean_and_noise(var,scen, mem, resample_interval):
    ...
    ens_mean_sub_member = ens_mean_sub_member.sel(latitude=slice(20,55),longitude=slice(230,256))
    ...
    for ens_mem in range(1,101):
        ...
        mem_da = mem_da.sel(latitude=slice(20,55),longitude=slice(230,256))
...
def get_obs_data(var, mem, resample_interval):
    ...
    da = da.sel(latitude=slice(20,55),longitude=slice(230,256))
...
def plot_summary(var,t,resample_interval):
    ...
    summary_df = pd.read_csv("/nesi/project/niwa00015/queenle/data/fire_OF/PM_summaries/smaller_"+var+"_" +resample_interval + "_trunc_" + str(t) + ".csv")
    ...
    for sort_type in ['nat_best','ant_best']:
        ...
        plt.savefig('/nesi/project/niwa00015/queenle/plots/fire/perfect_model/'+var+'/6month_fire_season/' + resample_interval + '/smaller_' + 'PM_ensemble_summary_'+sort_type+'_sort.png')
...
with open("/nesi/project/niwa00015/queenle/data/fire_OF/PM_summaries/smaller_"+var+"_" +resample_interval + "_trunc_" + str(t) + ".csv", 'w') as f:
