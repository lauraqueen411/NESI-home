...
def main():
    ...
    for scen in ['All','Nat']:
        ...
        for num in ens_list:
            ...
            if os.path.exists("/nesi/project/niwa00015/queenle/data/fire/CAM5-1-1/FWI_"+scen+"_run"+num_string+".nc"):
                continue
...
def calc_and_save(scen,num_string):
    ds = xr.open_dataset('/nesi/project/niwa00015/queenle/data/fire/CAM5-1-1/inputs/FWI_inputs_'+scen+'_run'+num_string+'_1959-2018.nc')
    ...
    FWI_da.to_netcdf("/nesi/project/niwa00015/queenle/data/fire/CAM5-1-1/FWI_"+scen+"_run"+num_string+".nc")
